...
> Récit en miniature : une situation, un instant, une révélation. Tout tient en une page.
> Mis à jour le 02/06/2026 — Création initiale.

---

## Principes

- **Concentration extrême** : une seule scène, un seul instant, un seul pivot. Pas de backstory, pas de descriptions superflues.
- **Entrée in medias res** : la première phrase plante le décor et le conflit. Pas d'échauffement.
- **Chute obligatoire** : le dernier paragraphe (parfois la dernière ligne) retourne la situation ou en révèle le vrai sens. Le lecteur doit relire.
- **Économie de personnages** : 1-2 personnages max. Chaque mot doit en révéler quelque chose.
- **Unité d'effet** : tout le texte converge vers une seule émotion ou une seule idée. Si une phrase ne sert pas cet effet, la couper.

---

## Boîte à outils du flashiste

Techniques disponibles, jamais obligatoires — l'écrivain pioche selon les besoins du récit. La rareté fait la puissance.

- **La première phrase-piège** : une phrase qui semble banale et qui prend tout son sens à la relecture. Ex: « La dernière fois que j'ai vu ma mère, elle portait du rouge à lèvres. » → pourquoi est-ce la *dernière* fois ?
- **L'objet-foyer** : un objet concret autour duquel tout le récit s'organise. Une clé, une photo, une montre. L'objet condense l'histoire.
- **Le détail qui dit tout** : un seul détail sensoriel (un son, une odeur, une texture) qui remplace une page de description.
- **Le dialogue minimal** : 1-2 répliques, pas plus. Chaque mot porte. Le non-dit est plus important que le dit.

...
- **Limite stricte : 12 observations pour un recueil de poésie, 30 pour un roman** (peu importe la taille du projet). Cette contrainte est une discipline : elle te force à hiérarchiser, à ne garder que ce qui compte vraiment. Si tu atteins la limite avant la fin du projet, une nouvelle observation ne peut entrer qu'en remplaçant une moins importante.

...
10. **Cleanup** — supprimer les artéfacts de pipeline devenus inutiles :
    ...
    Conserver : `scenes/scene-NN.md`, `bible.md`, `bd-connaissances.md`, `notes/observations.md`, `notes/rex.md`, `notes/analyse-style.md`, tous les PDFs, `versions/[projet]-final.md`.
